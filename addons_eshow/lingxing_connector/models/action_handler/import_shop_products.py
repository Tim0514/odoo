...
class ImportShopProducts(ActionHandler):
    ...
    def prepare_req_body(self):
        ...
        if self._connector.name == "import_shop_products":
            req_body = {
                "sid": web_shop_ids,
    ...
    def process_response_result(self):
        ...
        for result in self._response_result.data:
            ...
            try:
                ...
                product_vals["review_star"] = ActionHandlerTools.cfloat(result["last_star"])
                ...
                product_asin = shop_product_asin_obj.create_or_update(product_asin_vals)
