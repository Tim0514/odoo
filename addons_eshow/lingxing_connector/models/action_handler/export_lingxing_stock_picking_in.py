...
class ExportLingxingStockPickingIn(ActionHandler):

    def __init__(self, connector, log_book, start_time=None, end_time=None, **kwargs):
        super(ExportLingxingStockPickingIn, self).__init__(connector, log_book, start_time, end_time, **kwargs)
