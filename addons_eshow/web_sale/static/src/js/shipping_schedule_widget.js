odoo.define('web_sale.ShippingScheduleWidget', function (require) {
'use strict';
...
var ShippingScheduleWidget = Widget.extend({
    template: 'shipping_schedule_main',
...
widgetRegistry.add("shipping_schedule_widget", ShippingScheduleWidget);

return ShippingScheduleWidget;
