...
class Shop(models.Model):
    ...
    shop_warehouse_ids = fields.One2many("web.sale.warehouse", inverse_name="default_shop_id", string='Web Shop Warehouse')

    default_shipping_method_id = fields.Many2one("web.sale.shipping.method", string="Default Shipping Method")

    default_shipping_schedule_group_id = fields.Many2one("web.sale.shipping.schedule.group", string="Default Shipping Schedule Group")
