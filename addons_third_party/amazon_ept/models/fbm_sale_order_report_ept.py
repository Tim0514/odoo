...
class FbmSaleOrderReportEpt(models.Model):
    ...
    def auto_import_unshipped_order_report(self, seller):
        ...
        if seller.id:
            sale_order_report = self.create(
                {'report_type': ReportType.GET_FLAT_FILE_ORDER_REPORT_DATA if seller.is_european_region else
    ...
    def default_get(self, field):
        ...
        if not field:
            return res
        res.update({'report_type': ReportType.GET_FLAT_FILE_ORDER_REPORT_DATA if self.seller_id.is_european_region
        else ReportType.GET_FLAT_FILE_ORDER_REPORT_DATA_TAX})
        return res
    ...
    def prepare_amazon_request_report_kwargs(self, seller):
        ...
        if kwargs:
            ...
            kwargs.update({'report_type': ReportType.GET_FLAT_FILE_ORDER_REPORT_DATA if seller.is_european_region
            else ReportType.GET_FLAT_FILE_ORDER_REPORT_DATA_TAX,
