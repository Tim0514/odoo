...
class ReportType(str, Enum):
    GET_FLAT_FILE_ORDER_REPORT_DATA = 'GET_FLAT_FILE_ORDER_REPORT_DATA_INVOICING'
    ...
    GET_AMAZON_FULFILLED_SHIPMENTS_DATA = 'GET_AMAZON_FULFILLED_SHIPMENTS_DATA_INVOICING'
    GET_AMAZON_FULFILLED_SHIPMENTS_DATA_US = 'GET_AMAZON_FULFILLED_SHIPMENTS_DATA_TAX'
